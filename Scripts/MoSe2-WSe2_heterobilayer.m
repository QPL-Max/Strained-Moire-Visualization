...
(* ::Input:: *)
(*General  WSe2/MoSe2 heterobilayer Moire  pattern under strain*)


(* ::Input:: *)
(*Definiton of WSe2/MoSe2 Bravais lattice *)


(* ::Input:: *)
(*a:=0.329(*Lattice constant of WSe2 in nm, https://www.science.org/doi/10.1126/sciadv.1501882*)*)
(*delta:=-0.004(*Lattice mismatch between MoSe2 and WSe2(https://doi.org/10.1016/0022-4596(87)90057-0). Strain is applied to the bottom WSe2 layer*)*)
...
(*nu:=0.19(*Poisson ratio for WSe2 value https://aip.scitation.org/doi/pdf/10.1063/1.4774090*)*)
(*phis:=90*)
(*ec[eu_]:=0.5*(1-nu)*eu*)
(*es[eu_]:=0.5*(1+nu)*eu*)
