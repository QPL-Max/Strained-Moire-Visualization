...
(* ::Input:: *)
(*General  WSe2 homobilayer Moire  pattern under strain*)


(* ::Input:: *)
(*Definiton of WSe2 Bravais lattice *)
...
(*unitCell[x_,y_]:={Red,Disk[unitvectorW[x,y],0.1a],Blue,Disk[unitvectorSe[x,y],0.1a],Gray,*)
