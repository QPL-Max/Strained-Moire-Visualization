...
(* ::Input:: *)
(*Create new bilayer Moire  pattern under strain*)


(* ::Input:: *)
(*Definiton of new bilayer Bravais lattice *)


(* ::Input:: *)
(*a:={0.3498,0.6338} (*Set new lattice constants*)*)
...
(*Graphics[Block[{unitVectA={1,0},unitVectB={Cos[beta Degree],Sin[beta Degree]}},Table[unitCell@@(unitVectA j+unitVectB k),{j,-2,2},{k,-2+Ceiling[j],2+Ceiling[j]}]],PlotRange->{{-1*a[[2]],1*a[[2]]},{-1*a[[2]],1*a[[2]]}}]*)
(**)
